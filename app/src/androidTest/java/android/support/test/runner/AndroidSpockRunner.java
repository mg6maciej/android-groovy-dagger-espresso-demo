...
/**
 * An {@link android.app.Instrumentation} that runs JUnit3 and JUnit4 tests against
...
public class AndroidSpockRunner extends MonitoringInstrumentation {
     ...
     * @param writer            the {@link java.io.PrintStream} to dump errors to
     * @param listeners         the {@link java.util.List} to add listeners to
     */
